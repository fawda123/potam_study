...
# save
tiff('figs/Fig1_bw.tif', height = 8, width = 6, units = 'in', compression = 'lzw', res = 300, family = 'serif')
grid.newpage()
...
# save plot
tiff('figs/Fig3_bw.tif', height = 8, width = 9, units = 'in', compression = 'lzw', res = 500, family = 'serif')
grid.arrange(
...
# color vectors
cols <- paste0('grey', c('90', '70', '50', '90', '70', '50', '30'))
...
# save
tiff('figs/Fig4_bw.tif', height = 8, width = 6, units = 'in', compression = 'lzw', res = 300, family = 'serif')
